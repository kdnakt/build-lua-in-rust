...
mod tests {
    ...
    fn test_hello() {
        ...
        assert_eq!(proto.byte_codes[0], ByteCode::GetField(1, 0, 0));
    ...
    fn test_multi_print() {
        ...
        assert_eq!(proto.byte_codes[1], ByteCode::LoadConst(2, 1));
        assert_eq!(proto.byte_codes[2], ByteCode::Call(1, 2, 0));
        assert_eq!(proto.byte_codes[3], ByteCode::GetField(1, 0, 0));
    ...
    fn test_print_keyword() {
        ...
        // print(true)
        assert_eq!(proto.byte_codes[0], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[1], ByteCode::LoadBool(2, true));
        assert_eq!(proto.byte_codes[2], ByteCode::Call(1, 2, 0));
        // print(false)
        assert_eq!(proto.byte_codes[3], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[4], ByteCode::LoadBool(2, false));
        assert_eq!(proto.byte_codes[5], ByteCode::Call(1, 2, 0));
        // print(nil)
        assert_eq!(proto.byte_codes[6], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[7], ByteCode::LoadNil(2, 1));
        assert_eq!(proto.byte_codes[8], ByteCode::Call(1, 2, 0));
        // print(print)
        assert_eq!(proto.byte_codes[9], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[10], ByteCode::GetField(2, 0, 0));
    ...
    fn test_print_numbers() {
        ...
        // print(123)
        assert_eq!(proto.byte_codes[0], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[1], ByteCode::LoadInt(2, 123));
        assert_eq!(proto.byte_codes[2], ByteCode::Call(1, 2, 0));
        // print(123.456)
        assert_eq!(proto.byte_codes[3], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[4], ByteCode::LoadConst(2, 1));
        assert_eq!(proto.byte_codes[5], ByteCode::Call(1, 2, 0));
        // local a = 123
        assert_eq!(proto.byte_codes[6], ByteCode::LoadInt(1, 123));
        // print(a)
        assert_eq!(proto.byte_codes[7], ByteCode::GetField(2, 0, 0));
        assert_eq!(proto.byte_codes[8], ByteCode::Move(3, 1));
        assert_eq!(proto.byte_codes[9], ByteCode::Call(2, 2, 0));
        // local b = 123.456
        assert_eq!(proto.byte_codes[10], ByteCode::LoadConst(2, 1));
        // print(b)
        assert_eq!(proto.byte_codes[11], ByteCode::GetField(3, 0, 0));
        assert_eq!(proto.byte_codes[12], ByteCode::Move(4, 2));
    ...
    fn test_print_local_func() {
        ...
        // local print = print
        assert_eq!(proto.byte_codes[0], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[1], ByteCode::Move(2, 1));
    ...
    fn test_print_table() {
        ...
        assert_eq!(proto.byte_codes[0], ByteCode::NewTable(1, 0, 1));
        assert_eq!(proto.byte_codes[1], ByteCode::SetFieldConst(1, 0, 1));
        assert_eq!(proto.byte_codes[2], ByteCode::GetField(2, 0, 2));
        assert_eq!(proto.byte_codes[3], ByteCode::GetField(3, 1, 0));
        assert_eq!(proto.byte_codes[4], ByteCode::Call(2, 2, 0));
        assert_eq!(proto.byte_codes[5], ByteCode::NewTable(2, 3, 0));
        assert_eq!(proto.byte_codes[6], ByteCode::LoadConst(3, 3));
        assert_eq!(proto.byte_codes[7], ByteCode::NewTable(4, 2, 0));
        assert_eq!(proto.byte_codes[8], ByteCode::LoadConst(5, 4));
        assert_eq!(proto.byte_codes[9], ByteCode::LoadInt(6, 1432));
        assert_eq!(proto.byte_codes[10], ByteCode::SetList(4, 2));
        assert_eq!(proto.byte_codes[11], ByteCode::LoadBool(5, true));
        assert_eq!(proto.byte_codes[12], ByteCode::SetList(2, 3));
        assert_eq!(proto.byte_codes[13], ByteCode::GetField(3, 0, 2));
        assert_eq!(proto.byte_codes[14], ByteCode::Move(4, 2));
        assert_eq!(proto.byte_codes[15], ByteCode::Call(3, 2, 0));
        assert_eq!(proto.byte_codes[16], ByteCode::GetField(3, 0, 2));
        assert_eq!(proto.byte_codes[17], ByteCode::GetInt(4, 2, 1));
        assert_eq!(proto.byte_codes[18], ByteCode::Call(3, 2, 0));
        assert_eq!(proto.byte_codes[19], ByteCode::GetField(3, 0, 2));
        assert_eq!(proto.byte_codes[20], ByteCode::GetInt(4, 2, 2));
        assert_eq!(proto.byte_codes[21], ByteCode::GetInt(4, 4, 1));
        assert_eq!(proto.byte_codes[22], ByteCode::Call(3, 2, 0));
        assert_eq!(proto.byte_codes[23], ByteCode::GetField(3, 0, 2));
        assert_eq!(proto.byte_codes[24], ByteCode::GetInt(4, 2, 2));
        assert_eq!(proto.byte_codes[25], ByteCode::GetInt(4, 4, 2));
        assert_eq!(proto.byte_codes[26], ByteCode::Call(3, 2, 0));
        assert_eq!(proto.byte_codes[27], ByteCode::GetField(3, 0, 2));
        assert_eq!(proto.byte_codes[28], ByteCode::GetInt(4, 2, 3));
    ...
    fn test_unop() {
        ...
        // print(-5)
        assert_eq!(proto.byte_codes[0], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[1], ByteCode::LoadInt(2, -5));
        assert_eq!(proto.byte_codes[2], ByteCode::Call(1, 2, 0));
        // print(-(-3)))
        assert_eq!(proto.byte_codes[3], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[4], ByteCode::LoadInt(2, 3));
        assert_eq!(proto.byte_codes[5], ByteCode::Call(1, 2, 0));
        // print(not true)
        assert_eq!(proto.byte_codes[6], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[7], ByteCode::LoadBool(2, false));
        assert_eq!(proto.byte_codes[8], ByteCode::Call(1, 2, 0));
        // print(not false)
        assert_eq!(proto.byte_codes[9], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[10], ByteCode::LoadBool(2, true));
        assert_eq!(proto.byte_codes[11], ByteCode::Call(1, 2, 0));
        // print(not nil)
        assert_eq!(proto.byte_codes[12], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[13], ByteCode::LoadBool(2, true));
        assert_eq!(proto.byte_codes[14], ByteCode::Call(1, 2, 0));
        // print(~7)
        assert_eq!(proto.byte_codes[15], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[16], ByteCode::LoadInt(2, -8));
        assert_eq!(proto.byte_codes[17], ByteCode::Call(1, 2, 0));
        // print(#"hello")
        assert_eq!(proto.byte_codes[18], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[19], ByteCode::LoadInt(2, 5));
    ...
    fn test_binop() {
        ...
        //g=10
        assert_eq!(proto.byte_codes[0], ByteCode::SetFieldConst(0, 0, 1));
        //local a,b,c=1.1,2.0,100
        assert_eq!(proto.byte_codes[1], ByteCode::LoadConst(1, 2));
        assert_eq!(proto.byte_codes[2], ByteCode::LoadConst(2, 3));
        assert_eq!(proto.byte_codes[3], ByteCode::LoadInt(3, 100));
        //print(100+g)
        assert_eq!(proto.byte_codes[4], ByteCode::GetField(4, 0, 4));
        assert_eq!(proto.byte_codes[5], ByteCode::GetField(5, 0, 0));
        assert_eq!(proto.byte_codes[6], ByteCode::AddInt(5, 5, 100));
        assert_eq!(proto.byte_codes[7], ByteCode::Call(4, 2, 0));
        //print(a-1)
        assert_eq!(proto.byte_codes[8], ByteCode::GetField(4, 0, 4));
        assert_eq!(proto.byte_codes[9], ByteCode::SubInt(5, 1, 1));
        assert_eq!(proto.byte_codes[10], ByteCode::Call(4, 2, 0));
        //print(100/c)
        assert_eq!(proto.byte_codes[11], ByteCode::GetField(4, 0, 4));
        assert_eq!(proto.byte_codes[12], ByteCode::LoadInt(5, 100));
        assert_eq!(proto.byte_codes[13], ByteCode::Div(5, 5, 3));
        assert_eq!(proto.byte_codes[14], ByteCode::Call(4, 2, 0));
        //print(100>>b)
        assert_eq!(proto.byte_codes[15], ByteCode::GetField(4, 0, 4));
        assert_eq!(proto.byte_codes[16], ByteCode::LoadInt(5, 100));
        assert_eq!(proto.byte_codes[17], ByteCode::ShiftR(5, 5, 2));
        assert_eq!(proto.byte_codes[18], ByteCode::Call(4, 2, 0));
        //print(100>>a)
        assert_eq!(proto.byte_codes[19], ByteCode::GetField(4, 0, 4));
        assert_eq!(proto.byte_codes[20], ByteCode::LoadInt(5, 100));
        assert_eq!(proto.byte_codes[21], ByteCode::ShiftR(5, 5, 1));
    ...
    fn test_if() {
        ...
        // if a then
        assert_eq!(proto.byte_codes[0], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[1], ByteCode::TestOrJump(1, 3));
        // print "skip this"
        assert_eq!(proto.byte_codes[2], ByteCode::GetField(1, 0, 1));
        assert_eq!(proto.byte_codes[3], ByteCode::LoadConst(2, 2));
        assert_eq!(proto.byte_codes[4], ByteCode::Call(1, 2, 0));
        // end
        // if print then
        assert_eq!(proto.byte_codes[5], ByteCode::GetField(1, 0, 1));
        assert_eq!(proto.byte_codes[6], ByteCode::TestOrJump(1, 4));
        // local a = "I am true"
        assert_eq!(proto.byte_codes[7], ByteCode::LoadConst(1, 3));
        assert_eq!(proto.byte_codes[8], ByteCode::GetField(2, 0, 1));
        assert_eq!(proto.byte_codes[9], ByteCode::Move(3, 1));
        assert_eq!(proto.byte_codes[10], ByteCode::Call(2, 2, 0));
        // end
        // print(a) -- should be nil
        assert_eq!(proto.byte_codes[11], ByteCode::GetField(1, 0, 1));
        assert_eq!(proto.byte_codes[12], ByteCode::GetField(2, 0, 0));
        assert_eq!(proto.byte_codes[13], ByteCode::Call(1, 2, 0));
        // if a then
        assert_eq!(proto.byte_codes[14], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[15], ByteCode::TestOrJump(1, 4));
        // print "skip this"
        assert_eq!(proto.byte_codes[16], ByteCode::GetField(1, 0, 1));
        ...
        // print "else branch"
        assert_eq!(proto.byte_codes[20], ByteCode::GetField(1, 0, 1));
        assert_eq!(proto.byte_codes[21], ByteCode::LoadConst(2, 4));
        assert_eq!(proto.byte_codes[22], ByteCode::Call(1, 2, 0));
        // if a then
        assert_eq!(proto.byte_codes[23], ByteCode::GetField(1, 0, 0));
        assert_eq!(proto.byte_codes[24], ByteCode::TestOrJump(1, 4));
        // print "skip this"
        assert_eq!(proto.byte_codes[25], ByteCode::GetField(1, 0, 1));
        ...
        assert_eq!(proto.byte_codes[29], ByteCode::GetField(1, 0, 1));
        assert_eq!(proto.byte_codes[30], ByteCode::TestOrJump(1, 4));
        // print "elseif branch"
        assert_eq!(proto.byte_codes[31], ByteCode::GetField(1, 0, 1));
        ...
        // print "else branch"
        assert_eq!(proto.byte_codes[35], ByteCode::GetField(1, 0, 1));
